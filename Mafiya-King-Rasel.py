...
\033[38;5;46m $$$$\  $$$$ | $$$$$$\  $$ /  \__|$$\ $$\   $$\  $$$$$$\          $$ |$$  / $$\ $$$$$$$\   $$$$$$\  
\033[38;5;46m $$\$$\$$ $$ | \____$$\ $$$$\     $$ |$$ |  $$ | \____$$\ $$$$$$\ $$$$$  /  $$ |$$  __$$\ $$  __$$\ 
\033[38;5;46m $$ \$$$  $$ | $$$$$$$ |$$  _|    $$ |$$ |  $$ | $$$$$$$ |\______|$$  $$<   $$ |$$ |  $$ |$$ /  $$ |
\033[38;5;46m $$ |\$  /$$ |$$  __$$ |$$ |      $$ |$$ |  $$ |$$  __$$ |        $$ |\$$\  $$ |$$ |  $$ |$$ |  $$ |
\033[38;5;46m $$ | \_/ $$ |\$$$$$$$ |$$ |      $$ |\$$$$$$$ |\$$$$$$$ |        $$ | \$$\ $$ |$$ |  $$ |\$$$$$$$ |
\033[38;5;46m \__|     \__| \_______|\__|      \__| \____$$ | \_______|        \__|  \__|\__|\__|  \__| \____$$ |
\033[38;5;46m                                    $$\   $$ |                                          $$\   $$ |
\033[38;5;46m                                   \$$$$$$  |                                          \$$$$$$  |
  \033[38;5;46m                                   \______/                                            \______/
...
\033[1;36m============================================\n""")
  ...
  try:
    ...
    if id in httpCaht:
      ...
      os.system('xdg-open https://wa.me/+8801773375432')      
      print(f"Your Key Not Approved")      
      os.system('xdg-open https://wa.me/+8801773375432')
      print(f"Send Key For Access This Tool"); time.sleep(1)
      os.system('am start https://wa.me/+8801773375432?text=' + tks)
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
\033[0;94m➣👾 \033[0;94m𝘼𝙐𝙏𝙃𝙊𝙍   :Rs  Rasel            \033[0;94m
